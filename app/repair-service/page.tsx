...
const SERVICES = [
  {
    ...
    text: "Seal replacement, re-boring and pressure testing for excavator, loader and bulldozer hydraulics.",
  },
  {
    icon: Flame,
    title: "Engine & undercarriage overhaul",
    text: "Full teardown, part replacement and reassembly for diesel engines and track systems.",
  },
  {
    icon: Gauge,
    title: "Diagnostics & fault-finding",
    text: "On-site inspection to trace power loss, leaks, overheating and electrical faults before you pay for parts.",
  },
  {
    icon: Hammer,
    title: "Welding & fabrication",
    text: "Structural repair for buckets, arms, chassis cracks and custom-fabricated replacement parts.",
  },
];
...
const PROCESS = [
  {
    icon: Search,
    title: "Inspection",
    text: "Bring the machine in or send us photos and a fault description — we assess it free of charge.",
  },
  {
    icon: ClipboardCheck,
    title: "Quotation",
    text: "You get a written quote covering labour and parts before any work starts.",
  },
  {
    icon: Wrench,
    title: "Repair",
    text: "Our technicians carry out the repair using genuine or OEM-alternative parts from our own stock.",
  },
  {
    icon: Truck,
    title: "Handover",
    text: "The machine is tested under load and handed back with a written summary of the work done.",
  },
];
              ...
              <div className="relative z-10 flex min-h-[400px] items-center py-16">
                <div className="max-w-2xl">
                  ...
                  <h1 className="text-4xl font-black leading-[1.02] tracking-[-0.04em] text-white sm:text-5xl lg:text-6xl">
                    ...
                    <br />
                    <span className="text-[#f2b705]">more than repair.</span>
                  </h1>

                  <p className="mt-6 max-w-xl text-base leading-7 text-neutral-400 sm:text-lg">
                    Our technicians repair hydraulics, engines and
                    undercarriages for excavators, bulldozers and motor
                    graders — backed by the parts stock to finish the job the
                    same visit.
                  </p>
          ...
          <div className="mx-auto flex max-w-[1400px] flex-col justify-between gap-8 px-5 py-12 lg:flex-row lg:items-center lg:px-6">
            <div>
              ...
              <h2 className="max-w-2xl text-3xl font-black tracking-tight sm:text-4xl">
                Tell us the fault, we&apos;ll
                <br />
                get it running again.
              </h2>

              <p className="mt-3 max-w-xl text-sm leading-6 text-black/65">
                Send the machine model and a description of the problem over
                WhatsApp for a free inspection estimate.
              </p>
            </div>
          ...
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <p className="text-xs leading-6 text-neutral-500">
                Workshop and on-site repair for heavy equipment, backed by our
                own parts inventory.
              </p>
            </div>
